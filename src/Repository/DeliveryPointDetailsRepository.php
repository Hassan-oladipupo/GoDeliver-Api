...
use App\Entity\DeliveryPointDetails;
 ...
 */
class DeliveryPointDetailsRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, DeliveryPointDetails::class);
    }
